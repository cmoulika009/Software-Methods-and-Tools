...
public class SnakeGame extends JFrame {
	 ...
	 */
	public static final long serialVersionUID = 6678292058307426314L;
	...
	public int fruitTilePositionX;

	public int fruitTilePositionY;
			...
			for (int y = 0; y < BoardPanel.ROW_COUNT; y++) {
				...
				if (type == null || type == TileType.Fruit) {
					if (++freeFound == index) {
						...
						fruitTilePositionX = x;// 1.1vc
						fruitTilePositionY = y;// 1.1vc
						break;
					}
				}
			}
	...
	public boolean setIsPaused(boolean isPaused) {
		return isPaused;
	}
