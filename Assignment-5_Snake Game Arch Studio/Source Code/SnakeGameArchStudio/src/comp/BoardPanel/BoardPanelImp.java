...
public class BoardPanelImp extends JPanel implements IBoardPanelImp {
	...
	public BoardPanelImp(SnakeGame game) {
		this.game = game;
	...
	public void paintComponent(Graphics g) {
		 ...
		 */
		if(game.isGameOver()||game.isGameOver2() || game.isNewGame() || game.isPaused()) {
			...
			if(game.isNewGame()) {
				...
				largeMessage = "Game Over & Player-2 Won the Game!";
				smallMessage = "Press Enter to Restart";
			}
			else if(game.isGameOver2()) {
				largeMessage = "Game Over & Player-1 Won the Game!";
				smallMessage = "Press Enter to Restart";
