package edu.moulika.boardPanel;
 ...
 * ---------------------     --------------    ------------        -------------
 *  Moulika Chadalavada        7-Mar-2017         1.1vc        Changes as part of SMT Assignment
 *  
 *  
 ************************************************************************************************/
...
public class BoardPanel extends JPanel implements BoardInterface {//1.1vc implemented Interface
	...
	public void paintComponent(Graphics g) {
		...
		if(game.isGameOver() || game.isNewGame() || game.isPaused()) {
			...
			if(game.isNewGame()) {
				largeMessage = "Welcome to Snake Game";
				...
				largeMessage = "Paused";
				smallMessage = "Press P to Resume Game";
			}
